...
//----------------------------------------------------------------------------------------------------------
//
void DancerMesh::findTriangleParamsForStickyPoints(vector<StickyPoint>& _stickyPoints)
{
...
//----------------------------------------------------------------------------------------------------------
//
void DancerMesh::updateStickyPoints(vector<StickyPoint>& _stickyPoints)
{
	updateStickyPoints(_stickyPoints, triangleMesh );
}
