...
class DancerMesh
{
	public:
		...
		void					updateRandomPointMesh(int _numPoints, vector<MeshPoint>& _newRandomPoints, int _seed = -1 );
		void					updateRandomPointMesh(int _numPoints, vector<MeshPoint>& _newRandomPoints, ofImage& _emissionMask, int _seed = -1 );
		void					updateRandomPointMesh( int _numPoints, vector<MeshPoint>& _newRandomPoints, ofMesh& _sourceTriangleMesh,
