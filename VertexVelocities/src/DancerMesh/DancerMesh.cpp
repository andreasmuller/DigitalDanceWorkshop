...
//----------------------------------------------------------------------------------------------------------
//
void DancerMesh::updateRandomPointMesh(int _numPoints, vector<MeshPoint>& _newRandomPoints, int _seed)
{
	updateRandomPointMesh(_numPoints, _newRandomPoints, emptyMask, _seed );
}

//----------------------------------------------------------------------------------------------------------
//
void DancerMesh::updateRandomPointMesh(int _numPoints, vector<MeshPoint>& _newRandomPoints, ofImage& _emissionMask, int _seed )
{
	updateRandomPointMesh( _numPoints, _newRandomPoints, triangleMesh, triangleAreaWeightedDistribution, _emissionMask, _seed );
}
